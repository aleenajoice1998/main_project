...
$qry="INSERT INTO `pet_breed`( `pet_type`,`b_name`) VALUES ('$pet_type','$b_name')";
insert($qry);
 msg("Successfully Added");
 redirect('ps_view_pet_breed.php');
}
?>
<!DOCTYPE html>
<html>
...
<body background="images/p25.jpg">
	...
	<form action="add_pet_breed.php" method="POST">
	<center>
  ...
  <option value="fish">Fish</option>
	...
	<label style="font-family:Courier New;display: inline-block;text-align: left;;width: 150px"><b>Breed Name </b></label><input type="text" name="b_name"  required><br><br>
